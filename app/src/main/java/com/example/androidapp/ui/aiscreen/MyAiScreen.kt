...
import com.example.androidapp.ui.theme.BotColor
import com.example.androidapp.ui.theme.UserColor
...
fun getMockBotResponse(userInput: String): String {
    ...
    return when (userInput) {
        ...
        "Do I deserve to eat?" -> "Yes, you deserve to nourish your body with food that supports your health and well-being. Challenge any negative thoughts about deserving or not deserving food, and remind yourself that everyone deserves to eat."
    ...
    Row(
        ...
        Box(
            ...
            if(message.sender == "Bot") {
                Column {
                    BotPartAi(name = "Ai Bot", id = R.drawable.bot_icon)
